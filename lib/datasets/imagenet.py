...
class imagenet(datasets.imdb):
    def __init__(self, image_set, devkit_path):
        ...
        self._devkit_path, 'ILSVRC2013_DET_' + self._image_set[:-1])
        print("devkit path: {}".format(self._devkit_path))
        print (os.path.join(self._devkit_path, 'data', 'meta_det.mat'))
        synsets = sio.loadmat(
            os.path.join(self._devkit_path, 'data', 'meta_det.mat'))
        #print("mat path: {}".format(synsets))
        ...
        print ("number of classes is: "+ repr(self.num_classes))
    ...
    def _load_image_set_index(self):
        ...
        image_set_file = os.path.join(self._devkit_path, 'data', 'det_lists',
                                      self._image_set + '.txt')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [
            self._load_imagenet_annotation(index) for index in self.image_index
        ]
    ...
    def _load_selective_search_roidb(self, gt_roidb):
        filename = os.path.abspath(
            os.path.join(self._devkit_path, 'selective_search_data',
                         self.name + '.mat'))
        assert os.path.exists(filename), \
...
#box_list.append(raw_data[i][:, (1, 0, 3, 2)])
    ...
    def _load_selective_search_IJCV_roidb(self, gt_roidb):
        IJCV_path = os.path.abspath(
            os.path.join(self.cache_path, '..', 'selective_search_IJCV_data',
                         self.name))
    ...
    def _load_imagenet_annotation(self, index):
        ...
        filename = os.path.join(self._devkit_path,
                                'ILSVRC2013_DET_bbox_' + self._image_set,
                                index[:23] + '.xml')
        ...
        for ix, obj in enumerate(objs):
            ...
            cls = self._wnid_to_ind[str(get_data_from_tag(
    ...
    def _do_matlab_eval(self, comp_id, output_dir='output'):
        ...
        path = os.path.join(
            os.path.dirname(__file__), 'VOCdevkit-matlab-wrapper')
        cmd = 'cd {} && '.format(path)
